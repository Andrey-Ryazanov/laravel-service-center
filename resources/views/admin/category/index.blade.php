 ...
 <div class="content-header">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href = "{{ route('category.simpleexport') }}" style = "float:right;" class = "btn btn-success">Экспорт</a>
                <div class="form-inline mb-3">
                    <input type="text" name="search" class="form-control mr-sm-2 search" placeholder="Поиск">
                    <a href='{{ route('category.index') }}' type="submit" class="btn btn-primary btn-search">Искать</a>
                </div>
            </div>
        </div>
          
        <div class ="table_categories">
            @include('ajax.admin.categories.index')
        </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
