...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                 <a href = "service/export/simple" style = "float:right" class ="btn btn-success">Экспорт</a>
                <div class="form-inline mb-3">
                    <input type="text" name="search" class="form-control mr-sm-2 search" placeholder="Поиск">
                    <a href='{{ route('service.index') }}' type="submit" class="btn btn-primary btn-search">Искать</a>
                </div>
            </div>
        </div>
        <div class = "table_services">
            @include('ajax.admin.services.index')
        </div>
        </div>
    </div>
</section>
