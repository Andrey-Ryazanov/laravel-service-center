...
return [
    ...
    'accepted_if' => ':attribute должен быть принят, когда :other имеет значение :value.',
    ...
    'alpha_dash' => ':attribute может содержать только буквы, цифры и знаки подчеркивания или дефисы.',
    ...
    'present' => ':attribute должно быть указано.',
    'prohibited' => ':attribute запрещено к использованию.',
    'prohibited_if' => ':attribute запрещено к использованию когда :other имеет значение :value.',
    'prohibited_unless' => ':attribute запрещено к использованию если :other не имеет значение :values.',
    'prohibits' => ':attribute запрещено использовать, если :other указано.',
    'regex' => 'Неверный формат поля :attribute.',
    'required' => 'Поле :attribute обязательно для заполнения.',
    'required_array_keys' => 'Для :attribute обязательно указать значение :values.',
    'required_if' => 'Поле :attribute обязательно для заполнения, если :other имеет значение :value.',
    'required_unless' => 'Поле :attribute обязательно для заполнения, если :other не имеет значение :values.',
    'required_with' => 'Поле :attribute обязательно для заполнения, если указано значение :values.',
    'required_with_all' => 'Поле :attribute обязательно для заполнения, если указаны значения :values.',
    'required_without' => 'Поле :attribute обязательно, когда :values не указано.',
    'required_without_all' => 'Поле :attribute обязательно, когда ни один из :values не указан.',
